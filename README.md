# Twingate Connect Action for Windows
A GitHub action for connecting to Twingate on Windows GitHub Actions runners
...
# Usage
```yaml
- uses: nex-health/setup-twingate-windows@v1
  with:
